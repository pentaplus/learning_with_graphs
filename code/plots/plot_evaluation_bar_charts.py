...
DATA_SD = np.array(
    [[WEISFEILER_LEHMAN, MUTAG, 91.3, 0.8, 110.3/10 + 0.6],
     ...
     [EIGEN_KERNEL, MUTAG, 89.1, 0.8, 106.2/10 + 14.9],
     [EIGEN_KERNEL, PTC_MR, 61.7, 0.6, 122.6/10 + 65.6],
     [EIGEN_KERNEL, ENZYMES, 24.7, 0.9, 551.4/10 + 125.3]])
...
DATA_LD = np.array(
    [[WEISFEILER_LEHMAN, DD, 79.1, 0.5, 2170.2/10 + 31.9],
     ...
     [EIGEN_KERNEL, DD, 76.3, 0.5, 1648.1/10 + 7017.6],
     [EIGEN_KERNEL, NCI1, 64.0, 0.4, 1043.3/10 + 984.5],
     [EIGEN_KERNEL, NCI109, 64.9, 0.2, 1078.7/10 + 991.2],
     [EIGEN_KERNEL, FLASH_CFG, 80.6, 0.1, 2682.7/10 + 7503.9],
